...
<body>
    <div class="product-container">
        ...
        WHERE categories.name = 'Thời trang nữ';");
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            $productImg = htmlspecialchars($row['img'], ENT_QUOTES, 'UTF-8');
    ...
    <div id="productModal" class="modal">
        <div class="modal-content">
            ...
            <?php foreach ($sizes as $size): ?>
                <button class="size-btn" data-size="<?= htmlspecialchars($size['size_id'], ENT_QUOTES, 'UTF-8'); ?>">
                    <?= htmlspecialchars($size['size_name'], ENT_QUOTES, 'UTF-8'); ?>
                </button>
            <?php endforeach; ?>
            </div>
